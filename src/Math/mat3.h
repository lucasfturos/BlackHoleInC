...
static void Mat3_print(Mat3 m) __attribute__((unused));
static void Mat3_print(Mat3 m) {
    printf("Matrix:\n");
...
//! Operations
static Mat3 Mat3_add(Mat3 m1, Mat3 m2) __attribute__((unused));
static Mat3 Mat3_add(Mat3 m1, Mat3 m2) {
    return Mat3_create(Vec3_add(m1.v[0], m2.v[0]), Vec3_add(m1.v[1], m2.v[1]),
                       Vec3_add(m1.v[2], m2.v[2]));
}

static Mat3 Mat3_sub(Mat3 m1, Mat3 m2) __attribute__((unused));
static Mat3 Mat3_sub(Mat3 m1, Mat3 m2) {
    return Mat3_create(Vec3_sub(m1.v[0], m2.v[0]), Vec3_sub(m1.v[1], m2.v[1]),
                       Vec3_sub(m1.v[2], m2.v[2]));
}

static Mat3 Mat3_transpose(Mat3 m) __attribute__((unused));
...
static Mat3 Mat3_mul_scalar(Mat3 m, double scalar) __attribute__((unused));
static Mat3 Mat3_mul_scalar(Mat3 m, double scalar) {
    return Mat3_create(Vec3_mul_scalar(m.v[0], scalar),
                       Vec3_mul_scalar(m.v[1], scalar),
                       Vec3_mul_scalar(m.v[2], scalar));
}

static Mat3 Mat3_div_scalar(Mat3 m, double scalar) __attribute__((unused));
static Mat3 Mat3_div_scalar(Mat3 m, double scalar) {
    return Mat3_create(Vec3_div_scalar(m.v[0], scalar),
                       Vec3_div_scalar(m.v[1], scalar),
                       Vec3_div_scalar(m.v[2], scalar));
}

static Mat3 Mat3_mul(Mat3 m1, Mat3 m2) __attribute__((unused));
static Mat3 Mat3_mul(Mat3 m1, Mat3 m2) {
...
//! Mat3 Operations
static Vec3 Mat3_mul_vec3(Mat3 m, Vec3 v) __attribute__((unused));
...
static Mat3 Mat3_normalize(Mat3 m) __attribute__((unused));
static Mat3 Mat3_normalize(Mat3 m) {
